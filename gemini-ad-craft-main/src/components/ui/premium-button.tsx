  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-primary text-primary-foreground shadow-lg hover:scale-105 hover:shadow-xl glow-primary relative overflow-hidden",
        glass: "glass-input text-foreground hover:glow-primary backdrop-blur-xl",
        hero: "bg-gradient-primary text-white font-semibold shadow-2xl hover:scale-105 hover:shadow-accent/50 glow-accent relative overflow-hidden group",
      },
      size: {
